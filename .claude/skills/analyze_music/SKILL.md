...
1. Infer harmonic context, preferably as chord symbols or roman numerals.
   ...
   **Harmonic Rhythm**
   ...
   - "Regular" is judged per recurring melodic figure, not per measure. A beat-3 split that recurs at the same beat in every measure sharing a melodic shape (e.g. every cadential measure of a repeated phrase) is regular by definition, even though the measures between them hold one chord — don't flag that alternation as uneven, and don't water it down to one chord per measure for uniformity's sake. The real irregularity to avoid is the same figure being split in one place and held in another.

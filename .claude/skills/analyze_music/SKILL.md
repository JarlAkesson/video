...
6. Infer harmonic context, preferably as chord symbols or roman numerals.
   ...
   **Harmonic Rhythm**
   ...
   - Before explaining a strong-beat note as a departure/passing tone to keep the chord held, check whether it's instead a direct, undecorated fit for a different chord — and prefer that reading when it also fits the established harmonic rhythm (e.g. lines up with a beat-3 change already used nearby), even if the departure reading technically verifies too.
